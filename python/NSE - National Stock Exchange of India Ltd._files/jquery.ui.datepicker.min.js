 ...
 *	jquery.ui.core.js
 */
(function(d,G){function K(){//Added By Swapnil 
	var cDate=new Date
	var endYear = 2015;
	endYear = cDate.getFullYear();
	var startYear = cDate.getFullYear()-1994;
	//alert(startYear);
	//End
...
"Mo","Tu","We","Th","Fr","Sa"],weekHeader:"Wk",dateFormat:"mm/dd/yy",firstDay:0,isRTL:false,showMonthAfterYear:false,yearSuffix:""};this._defaults={showOn:"focus",showAnim:"fadeIn",showOptions:{},defaultDate:null,appendText:"",buttonText:"...",buttonImage:"",buttonImageOnly:false,hideIfNoPrevNext:false,navigationAsDateFormat:false,gotoCurrent:false,changeMonth:false,changeYear:false,yearRange:"c-"+startYear+":"+endYear,showOtherMonths:true,selectOtherMonths:true,showWeek:false,calculateWeek:this.iso8601Week,shortYearCutoff:"+10",
